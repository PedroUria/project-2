...
Let's how well our model predicts the oscar winners in our training set, using cross_validation.
...
Let's also verify our results using cross-validation:
