...
dim(xw)
xw = cbind(xw,baf_or_screen, baf_ad_screen, baf_hair)
```
#BAFTA Nom
```{r}
...
best_male_breakthrough = xw$`oftv_won_Best_Breakthrough_Performance:_Male` + xw$`oftv_won_Best_Breakthrough_Performance_-_Male`

best_female_breakthrough = xw$`oftv_won_Best_Breakthrough_Performance:_Female` + xw$`oftv_won_Best_Breakthrough_Performance_-_Female`
...
xw = cbind(xw,best_male_breakthrough,best_female_breakthrough)
...
best_male_breakthrough = x$`oftv_nom_Best_Breakthrough_Performance:_Male` + x$`oftv_nom_Best_Breakthrough_Performance_-_Male`

best_female_breakthrough = x$`oftv_nom_Best_Breakthrough_Performance:_Female` + x$`oftv_nom_Best_Breakthrough_Performance_-_Female`
...
x = cbind(x,best_male_breakthrough,best_female_breakthrough)
...
best_adpated_scrnply = xw$ofcs_won_Best_Adapted_Screenplay + xw$`ofcs_won_Best_Screenplay,_Adapted`

best_orig_scrnply = xw$ofcs_won_Best_Original_Screenplay + xw$`ofcs_won_Best_Screenplay,_Original`

max(best_adpated_scrnply)
max(best_orig_scrnply)
...
xw = cbind(xw,best_orig_scrnply,best_adpated_scrnply)
```
...
best_adpated_scrnply = x$ofcs_nom_Best_Adapted_Screenplay + x$`ofcs_nom_Best_Screenplay,_Adapted`

best_orig_scrnply = x$ofcs_nom_Best_Original_Screenplay + x$`ofcs_nom_Best_Screenplay,_Original`
...
x = cbind(x,best_orig_scrnply,best_adpated_scrnply)
...
best_drama = xw$pc_won_Favorite_Drama_Movie + xw$pc_won_Favorite_Movie_Drama

best_comedy = xw$pc_won_Favorite_Movie_Comedy+ xw$pc_won_Favorite_Comedy_Movie

best_onscrn_matchup = xw$`pc_won_Favorite_On-Screen_Match-Up` + xw$`pc_won_Favorite_On_Screen_Match-up`

max(best_drama)
max(best_comedy)
max(best_onscrn_matchup)
...
xw = cbind(xw,best_drama,best_comedy,best_onscrn_matchup)
```
# PC nominated
```{r}
...
best_drama = x$pc_nom_Favorite_Drama_Movie + x$pc_nom_Favorite_Movie_Drama

best_comedy = x$pc_nom_Favorite_Movie_Comedy+ x$pc_nom_Favorite_Comedy_Movie

best_onscrn_matchup = x$`pc_nom_Favorite_On-Screen_Match-Up` + x$`pc_nom_Favorite_On_Screen_Match-up`
...
x = cbind(x,best_drama,best_comedy,best_onscrn_matchup)
...
best_comedy_or_musical = xw$`ace_won_Best_Edited_Feature_Film_(Comedy_or_Musical)` + xw$`ace_won_Best_Edited_Feature_Film_-_Comedy_or_Musical`

best_dramatic = xw$`ace_won_Best_Edited_Feature_Film_(Dramatic)` + xw$`ace_won_Best_Edited_Feature_Film_-_Dramatic`


max(best_dramatic)
max(best_comedy_or_musical)
...
xw = cbind(xw,best_dramatic,best_comedy_or_musical)
```
...
best_comedy_or_musical = x$`ace_nom_Best_Edited_Feature_Film_(Comedy_or_Musical)` + x$`ace_nom_Best_Edited_Feature_Film_-_Comedy_or_Musical`

best_dramatic = x$`ace_nom_Best_Edited_Feature_Film_(Dramatic)` + x$`ace_nom_Best_Edited_Feature_Film_-_Dramatic`
...
x = cbind(x,best_dramatic,best_comedy_or_musical)
